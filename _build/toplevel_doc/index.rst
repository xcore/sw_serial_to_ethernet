...
:Version: bef847863aaa37dbbccdbb1b46382b2bd27d0a64
:Vendor: XMOS
...
Serial to Ethernet bridging application (app_serial_to_ethernet)
 Reference application for serial to Ethernet bridge applications

Documentation
===============

  * `Serial to Ethernet (S2E) bridging application quickstart guide <././app_serial_to_ethernet/doc_quickstart/index.html>`_ `PDF <././app_serial_to_ethernet/doc_quickstart.pdf>`_ 
  * `Serial to Ethernet bridging application manual <././doc/index.html>`_ `PDF <././doc.pdf>`_ 
